...
ggplot(data = NULL, aes(x = c(null, non_null))) + 
  geom_histogram(binwidth = .05, alpha = 0.75, fill = "#0066ff", color = "black") +
  geom_vline(xintercept = 0.5, color = "navy", size = 1, linetype = 2) +
  xlab("p-values")
```
