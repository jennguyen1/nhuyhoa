...
option_list <- list(
  ...
  make_option("--y", action = "store_true", dest = "var", help = "If this boolean flag is activated var is set to true")
)
...
There are additional options to run the command, such as running the command in the background, etc.
