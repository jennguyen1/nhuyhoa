---
layout: post
title: "Classification: Naive Bayes & Discriminant Analysis"
...
Since the denominator is constant across all values of $$y$$, we can just focus on the numerator. Thus our goal is to find
