...
For binary classification problems, support vector machines may be used to find a plane that separates classes in the feature space. Features hsould be standardized prior to applying SVM.
...
{% highlight text %}
## Error in eval(expr, envir, enclos): could not find function "svm"
{% endhighlight %}
...
{% highlight text %}
## Error in summary(lin.svm.fit): object 'lin.svm.fit' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): object 'lin.svm.fit' not found
{% endhighlight %}
...
{% highlight text %}
## Error in plot(lin.svm.fit, lin_dat): object 'lin.svm.fit' not found
{% endhighlight %}
...
{% highlight text %}
## Error in summary(nonlin.svm.fit): object 'nonlin.svm.fit' not found
{% endhighlight %}
...
{% highlight text %}
## Error in plot(nonlin.svm.fit, nonlin_dat): object 'nonlin.svm.fit' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): could not find function "tune.svm"
{% endhighlight %}
...
{% highlight text %}
## Error in summary(tuned_svm.fit): object 'tuned_svm.fit' not found
{% endhighlight %}
