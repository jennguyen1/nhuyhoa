...
$$f(\overrightarrow{x}) =  \beta_0 + \beta_1 X_1 + ... + \beta_p X_p = 0$$ 
...
where $$\epsilon_i \ge 0$$ and $$\Sigma^n_{i = 1} \epsilon_i \le C$$

This is equivalent to  
$$min \| \overrightarrow{\beta} \| + C \Sigma^N_i \epsilon_i$$ with the constraints
